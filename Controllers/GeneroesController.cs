...
namespace WIS___PI___v2.Controllers
{
    public class GeneroesController : Controller
    {
        ...
        public GeneroesController(WIS___PI___v2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genero != null ? 
                          ...
                          Problem("Entity set 'WIS___PI___v2Context.Genero'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WIS___PI___v2Context.Genero'  is null.");
            }
            var genero = await _context.Genero.FindAsync(id);
            if (genero != null)
            {
